...
public class PersistenceStorage {
    ...
    public static final String ATTENDEE_STORAGE_PATH = "./phase2/storage/attendees.txt";
    public static final String SPEAKER_STORAGE_PATH = "./phase2/storage/speakers.txt";
    public static final String ORGANIZER_STORAGE_PATH = "./phase2/storage/organizers.txt";
    public static final String EVENT_STORAGE_PATH = "./phase2/storage/events.txt";
    public static final String ROOM_STORAGE_PATH = "./phase2/storage/rooms.txt";
    public static final String MESSAGE_STORAGE_PATH = "./phase2/storage/messages.txt";
    public static final String CONTACT_BOOK_PATH = "./phase2/storage/contact_book.txt";
    public static final String RATER_STORAGE_PATH= "./phase2/storage/raters.txt";
    public static final String AGREEMENT_STORAGE_PATH= "./phase2/storage/agreements.txt";
