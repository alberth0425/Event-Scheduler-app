...
public class PersistenceStorage {
    ...
    public static void deleleMessage(Message message) throws IOException {
        URL url = new URL(MESSAGE_DB_URL);
        HttpURLConnection con = (HttpURLConnection) url.openConnection();
        ...
        BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(con.getOutputStream()));
        String request = String.format("{\"message_id\":\"%s\", \"timestamp\":%d}", message.getUUID(), message.getTimeStamp());
        writer.write(request);
        writer.flush();
        writer.close();
        con.getResponseCode();
